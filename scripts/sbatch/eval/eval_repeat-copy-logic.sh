...
#SBATCH --nodes=1
#SBATCH --job-name=nvr_lacr_llm-eval.bb_repeat_copy_logic
...
echo "Evaluating $model_name at step $step on BB Repeat Copy Logic"
python -m eval.repeat_copy_logic.run_eval \
