...
#SBATCH --nodes=1
#SBATCH --job-name=nvr_lacr_llm-eval.bb_language_identification
...
echo "Evaluating $model_name at step $step on BB Language Identification"
python -m eval.language_identification.run_eval \
